...
# ​⚖️ 许可证 (License)
​本项目采用且只采用 GPLv3 协议发布

# 导览：

# AEFR 目前并不是一个为了讨好所有人而设计的复杂应用，因为仍未做出完整版本。它目前只是 1102 行直达底层的 Rust 逻辑所构成的一个内核。在计算机的世界里，最短的路径永远是最无敌的！如果你追求的是暂时的兼容性，请去用 AA；如果你追求的是极致的自由与性能，欢迎来到 AEFR
